...
from postgresql import EphemeralPostgreSqlDbContextBuilder, DbManagerProtocol, FilesManagerProtocol
...
class TestBuildingContextShould:
    ...
    def test_read_one_script_file(self, connection_string):
        ...
        db_manager = mock.Mock(spec=DbManagerProtocol)
        with EphemeralPostgreSqlDbContextBuilder(files_manager)\
